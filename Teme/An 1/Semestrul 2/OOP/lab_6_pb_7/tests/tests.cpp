...
void testAddRepo(){
    ...
    try{
        ...
        assert(true);
        assert(error.getMesaj() == "Medicamentul exista deja!");
    }
...
void testAddInFileRepo(){
    InFileRepository repoF("/Users/stiubedenis/Desktop/Facultate/Teme/Semestrul 2/OOP/lab_6_pb_7/tests/InFileRepoTest");
    ...
    clearFile("/Users/stiubedenis/Desktop/Facultate/Teme/Semestrul 2/OOP/lab_6_pb_7/tests/InFileRepoTest");
}
...
void testDeleteInFileRepo(){
    ...
    try{
        ...
        assert(err.getMesaj() == "Medicamentul nu exista!");
    }
    clearFile("/Users/stiubedenis/Desktop/Facultate/Teme/Semestrul 2/OOP/lab_6_pb_7/tests/InFileRepoTest");
}
...
void testDeleteFarmacieService(){
    ...
    try{
        ...
        assert(true);
        assert(error.getMesaj() == "Medicamentul nu exista!");
    }
...
void testExportToFile(){
    ...
    service.exportToFile("/Users/stiubedenis/Desktop/Facultate/Teme/Semestrul 2/OOP/lab_6_pb_7/tests/test_export");
    try{
